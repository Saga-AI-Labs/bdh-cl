...
1. **phase-1b — UPLOADED + FORMALLY VERIFIED + spot-checked; deletion gated on pi-50's fresh re-check** —
   ...
   re-runnable `scripts/quinn/verify_phase1b.py`; committed+pushed bdh@4b0161d.
