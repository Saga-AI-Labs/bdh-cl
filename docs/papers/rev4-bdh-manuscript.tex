...
\title{\bfseries Append-Only Neural Memory: Storage, Addressing, and Growth\\ \large in a Depth-Recurrent Language Model \textnormal{(Revision 4.6)}}
...
controlled it---83\% on the log scale (62\% in linear perplexity), a mechanism that reproduces across seven eras
